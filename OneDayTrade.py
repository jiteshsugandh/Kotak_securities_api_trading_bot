...
# One day a week trade for BankNifty STBT
CE_STRIKE = ATM_STRIKE + 200
PE_STRIKE = ATM_STRIKE - 200

#Short Straddle for BANKNIFTY
Option_Call = df[((df.segment == 'FO') & (df.instrumentType == 'OI') & (df.instrumentName == 'BANKNIFTY') & (df.strike == CE_STRIKE) & (df.optionType == 'CE'))]
Option_Put = df[((df.segment == 'FO') & (df.instrumentType == 'OI') & (df.instrumentName == 'BANKNIFTY') & (df.strike == PE_STRIKE) & (df.optionType == 'PE'))]
